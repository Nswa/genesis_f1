...
class RenderSliverStickyHeader extends RenderSliver with RenderSliverHelpers {
  ...
  void performLayout() {
    ...
    // Detect if reversed (vertical up or horizontal left)
    final bool isReversed = (axisDirection == AxisDirection.up || axisDirection == AxisDirection.left);
    ...
    if (header != null) {
      ...
      final double headerPosition = sticky
          ? (
              isReversed
                  // Pin to the top (0.0) when reversed
                  ? 0.0
                  : math.min(
                      constraints.overlap,
                      childScrollExtent -
      ...
      switch (axisDirection) {
        case AxisDirection.up:
          // Pin to the top (0.0) when reversed
          headerParentData!.paintOffset = Offset(0.0, 0.0);
          break;
        case AxisDirection.down:
