...
% Figure placeholder - path to be provided
 \begin{figure}[H]
 \centering
 \includegraphics[width=0.7\textwidth]{files/imgs/prototype/auth_registration.jpeg}
...
% Figure placeholder - path to be provided
 \begin{figure}[H]
 \centering
 \includegraphics[width=0.7\textwidth]{files/imgs/prototype/auth_google.jpeg}
...
% Figure placeholder - path to be provided
 \begin{figure}[H]
 \centering
 \includegraphics[width=0.7\textwidth]{files/imgs/prototype/auth_twitter.jpeg}
