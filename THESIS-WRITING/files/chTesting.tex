...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart1_ui_satisfaction.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart2_navigation_ease.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart3_performance.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart4_ai_insights.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart5_offline_sync.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart6_mood_analytics.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart7_goal_achievement.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart8_recommendation.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart9_distraction_free.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{files/imgs/chart10_overall_experience.png}
